...
let foodArray = ['tacos', 'pizza', 'steak', 'ramen'];
...
console.log('Added a favorite food to the end,', foodArray);
...
foodArray[1] = 'bacon';
console.log('Changed second food');
console.log('The foods are now', foodArray);
...
foodArray.sort();
foodArray.reverse();
console.log('Foods in reverse alphabetical order', foodArray);
